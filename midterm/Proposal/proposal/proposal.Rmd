...
The purpose of my work is to investigate the dataset about nuclear explosions. By editing the given dataset, I removed the rows that included "NA" values and also deleted the columns that were no use to me such as "magnitude_body" and "magnitude_surface". 

The question I decided on is "In which test site did the USA conduct the most nuclear tests?". To do this, I had to create a subset that had only the tests of USA and from that dataset I created another and the final dataset named "n_occur" that has the names of the nuclear test sites of USA and also how many times those names were repeated. With this data, I am able to see the most occuring name which is "NTS". The variable "NTS" occured for 902 times which meant that the USA conducted most of it's nuclear tests in NTS.  
